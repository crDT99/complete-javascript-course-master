 ...
 */function(t,n){if(n)return t.slice();var r=t.length,e=a?a(r):new t.constructor(r);return t.copy(e),e}}),// Exporting Module
console.log("Exporting Module");const c=[];function l(t,n){c.push({product:t,quantity:n}),console.log(`${n} ${t} added to the cart`)}var s=/**
 * @license
 ...
 */function(){var t=this.__wrapped__.value(),n=this.__dir__,r=Q(t),e=n<0,i=r?t.length:0,o=f8(0,i,this.__views__),u=o.start,a=o.end,f=a-u,c=e?a:u-1,l=this.__iteratees__,s=l.length,p=0,h=f6(f,this.__takeCount__);if(!r||!e&&i==f&&h==f)return aw(t,this.__actions__);var v=[];t:for(;f--&&p<h;){for(var d=-1,g=t[c+=n];++d<s;){var y=l[d],_=y.iteratee,b=y.type,m=_(g);if(2==b)g=m;else if(!m){if(1==b)continue t;break t}}v[p++]=g}return v},iB.prototype.at=ax.at,iB.prototype.chain=ax.wrapperChain,iB.prototype.commit=ax.commit,iB.prototype.next=ax.next,iB.prototype.plant=ax.plant,iB.prototype.reverse=ax.reverse,iB.prototype.toJSON=iB.prototype.valueOf=iB.prototype.value=ax.value,iB.prototype.first=iB.prototype.head,ct&&(iB.prototype[ct]=ax.toIterator),l("pizza",2),l("bread",5),l("apples",4),console.log(c);const ci={cart:[{product:"bread",quantity:5},{product:"pizza",quantity:5}],user:{loggedIn:!0}},co=Object.assign({},ci),cu=iB(ci);console.log(co),console.log("------------ FALSE -------------"),ci.user.loggedIn=!1,console.log(co),console.log("~~~~~~~~~~~~~~~"),console.log(cu),new class{#t="hey";constructor(t){this.name=t,console.log(`${this.#t}, ${this.name}`)}}("Cristian"),console.log("cristian"),console.log(c.find(t=>t.quantity>=2));//# sourceMappingURL=index.9b1da020.js.map

//# sourceMappingURL=index.9b1da020.js.map
